...
public class Samplers {
	...
	public static final String LATINLOWER = "abcdefghijklmnopqrstuvwxyz";
	public static final String LATINUPPER = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
	 ...
	 * @param alphabet alphabet to be used or null to use latin alphabet with
	 *        numbers
	 * @return
	 */
	public static String randString(int length, byte[] alphabet) {
		if (alphabet == null)
			alphabet = (LATINLOWER + LATINUPPER + NUMBERS).getBytes();
