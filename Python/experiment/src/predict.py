...
def getRecDict(playlistDict,songDict,recType = 0,lamda = 0.45,topN = const.TOP_N):
  recDict = {}
...
def getRecDictOfLSA(songDict,playlistDict,topN = const.TOP_N):
  ...
  #make topic models
  lsi = models.LsiModel(corpus_tfidf,id2word=dictionary,num_topics=const.TOPIC_NUM)
